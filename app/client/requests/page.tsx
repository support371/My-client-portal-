...
const FILE_TEXT_ICON = <FileText className="h-5 w-5 text-primary" />
 ...
 * Prevents re-rendering the entire history list when the form inputs (type/subject) change.
 */
const RequestItem = memo(function RequestItem({ req }: { req: RequestRow }) {
  return (
...
export default function ClientRequestsPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the request history list to ensure it only updates when requests change.
