...
/**
 * ⚡ Bolt Optimization: Memoize individual request list items.
 * Prevents redundant re-renders of existing requests when the form state
 * (type, subject, submitted) updates.
 */
