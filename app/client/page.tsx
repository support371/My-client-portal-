...
/**
 * ⚡ Bolt Optimization: Extract ClientHeader to localize session dependency.
 * This ensures that only the header re-renders when the auth session hydrates,
...
/**
 * ⚡ Bolt Optimization: Memoize PortfolioSummary section.
 * Prevents re-renders of the static/stable summary when the parent re-renders.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize VirtualTrading section.
 * Isolates the trading card from parent re-renders. Uses uncontrolled inputs
 * to keep local state from triggering unnecessary page-level updates.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize TransactionHistory section.
 * Prevents reconciliation of the transaction list unless the parent's data changes.
 * Since 'transactions' is a module-level constant, this skips renders entirely.
 */
