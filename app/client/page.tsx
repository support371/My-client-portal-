...
/**
 * ⚡ Bolt Optimization: Memoize Portfolio Summary.
 * Prevents redundant renders when other page state updates.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize Virtual Trading.
 * Isolates trading state and prevents redundant renders.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize Transaction History.
 * Ensures the transaction list container skips reconciliation unless transactions change.
 */
