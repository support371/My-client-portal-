...
/**
 * ⚡ Bolt Optimization: Memoize Portfolio Summary section.
 * This prevents the balance and action buttons from re-rendering
 * when unrelated page state (like trading inputs) changes.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize Virtual Trading section.
 * Localizes state updates (inputs) to this component and ensures
 * it doesn't re-render unnecessarily when parent state changes.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize Transaction History section.
 * Prevents the entire list from re-rendering when other page sections update.
 */
