...
// ⚡ Bolt Optimization: Hoist static Lucide icons to module-level constants.
// This ensures stable references and prevents redundant element creation during renders.
...
/**
 * ⚡ Bolt Optimization: Memoize individual user row items.
 * This ensures that only the table list itself re-renders during search updates,
 * rather than the internal DOM tree of every single row.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the filtering logic with a pre-normalized search query.
  // This avoids O(N) calculations on every render unless the users list or search query changes.
