...
// ⚡ Bolt Optimization: Hoist static Lucide icons to module-level constants for stable references.
...
/**
 * ⚡ Bolt Optimization: Memoize the individual user row.
 * This prevents all rows from re-rendering when the search input changes,
 * improving typing responsiveness for large user lists.
 */
...
export default function AdminUsersPage() {
  ...
  // Reduces redundant O(N) calculations during non-search-related re-renders.
