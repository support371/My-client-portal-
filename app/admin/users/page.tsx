...
// This ensures that memoized components don't re-render because of new
// icon object references on every parent render, saving unnecessary DOM operations.
 ...
 * Prevents unnecessary re-renders of list items that haven't changed
...
export default function AdminUsersPage() {
  ...
  // Pre-calculate the lowercased search term outside the filter loop to avoid
  // repeating .toLowerCase() / .trim() calls on every iteration.
