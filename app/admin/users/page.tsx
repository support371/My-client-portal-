...
// This ensures stable element references and prevents redundant React.createElement calls.
 ...
 * Prevents redundant re-renders of all rows when the parent search state changes.
 */
...
export default function AdminUsersPage() {
  ...
  // Avoids O(N) calculations and redundant string operations on every render.
