...
// ⚡ Bolt Optimization: Hoist static icons out of the render cycle to prevent needless re-creation of components/objects.
 ...
 * Keeps the table rows from re-rendering when the search input state updates.
 */
...
export default function AdminUsersPage() {
  ...
  // Avoids recalculating on every render cycle when unrelated state updates.
