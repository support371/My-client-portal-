...
// This prevents memoized components from re-rendering due to new icon object references.
 ...
 * This ensures that only the relevant row re-renders if its data changes,
 * and skips re-renders during high-frequency updates like search input typing.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic to prevent O(N) calculations on every render.
  // Pre-normalizing the search query outside the filter loop for efficiency.
