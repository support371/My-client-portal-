 ...
 * Prevents re-rendering the entire table when only the search input changes
 * or when a specific user's status is updated.
 */
...
export default function AdminUsersPage() {
  ...
  // This avoids redundant O(N) calculations on every render cycle unless 'users' or 'search' changes.
