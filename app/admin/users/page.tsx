...
// ⚡ Bolt Optimization: Move static icons out of the render cycle to preserve memoization references.
 ...
 * Prevents re-rendering all rows when search query input state updates.
 */
