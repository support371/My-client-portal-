 ...
 * Prevents re-rendering all rows when the search state changes in the parent component.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the filtering logic and normalize search query once.
