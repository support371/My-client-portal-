...
// This ensures stable references and prevents unnecessary re-renders of components receiving them as props.
 ...
 * Prevents re-rendering all rows when the search input changes or unrelated state updates.
 */
...
export default function AdminUsersPage() {
  ...
  // This avoids redundant O(N) calculations on every render.
