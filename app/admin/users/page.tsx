...
// ⚡ Bolt Optimization: Hoist static icons to constants outside the render function
 ...
 * Prevents redundant re-renders of list items when parent state (like typing in the search bar) changes.
 */
const UserRowComponent = memo(function UserRowComponent({ user }: UserRowComponentProps) {
  return (
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the filtered list with pre-normalized search query
