...
// ⚡ Bolt Optimization: Hoist static icons out of render function for stable references.
 ...
 * Prevents re-rendering all rows when unrelated state updates (e.g. search term typing).
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtered user list and normalize query once outside the loop.
