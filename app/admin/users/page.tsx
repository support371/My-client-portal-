...
// This ensures stable element references for memoized components.
...
const USER_AVATAR_ICON = <ShieldCheck className="h-4 w-4 text-primary" />
 ...
 * Skips redundant reconciliation for all rows when unrelated page state (like search) changes.
 */
...
export default function AdminUsersPage() {
  ...
  // Prevents O(N) string operations on every re-render unless search or users change.
