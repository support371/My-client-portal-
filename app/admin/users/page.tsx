 ...
 * Prevents unnecessary re-renders of the entire list when only search state changes.
 */
...
export default function AdminUsersPage() {
  ...
  // Reduces redundant string operations and filtering on every render cycle.
