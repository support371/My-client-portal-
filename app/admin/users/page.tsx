...
// This ensures stable references, allowing memoized components like PortalHeader to skip re-renders.
 ...
 * Prevents re-rendering the entire list when only the search state changes.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic and pre-normalize search query.
  // This avoids O(N) operations and repeated string lowercasing on every render.
