...
const USERS_PAGE_ICON = <Users className="h-5 w-5 text-primary" />
...
/**
 * ⚡ Bolt Optimization: Extract and memoize individual user rows.
 * Prevents redundant re-renders of the entire table when searching or updating.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtered results to prevent redundant O(N) filtering on every render.
  // Pre-calculates lowercase search term to avoid redundant calls inside the filter loop.
