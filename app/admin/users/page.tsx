...
// ⚡ Bolt Optimization: Define roleVariant outside the component scope.
...
// This prevents recreating these React elements/objects on every page render.
 ...
 * Prevents re-rendering rows during frequent typing updates in the search input.
 */
...
export default function AdminUsersPage() {
  ...
  // Normalizing the query outside of the loop reduces work and avoids O(N) calculations per render.
