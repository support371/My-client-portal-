 ...
 * Keeps individual row items from re-rendering during search query updates.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize search filtering to prevent recalculation on unrelated renders.
  // Normalizes search input once outside the filter loop for optimal performance.
