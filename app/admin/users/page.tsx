...
// ⚡ Bolt Optimization: Hoist static Lucide icons outside the component scope
// to prevent garbage collection and reference invalidation on every render cycle.
 ...
 * Prevents redundant rendering of rows when typing in the search bar.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the user filtering logic using useMemo.
  // We normalize the search term outside of the filter loop for optimal performance.
