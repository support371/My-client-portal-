...
// ⚡ Bolt Optimization: Hoist static icons to constants outside the render cycle.
 ...
 * Prevents re-rendering all rows when the search query changes but doesn't affect
 * a particular row's visibility or data.
 */
