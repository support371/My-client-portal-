...
// ⚡ Bolt Optimization: Hoist static icons out of render function to avoid recreating references.
...
// ⚡ Bolt Optimization: Define roleVariant outside of component scope.
 ...
 * This prevents unnecessary re-rendering of all user row items when search or filtering state updates.
 */
...
export default function AdminUsersPage() {
  ...
  // Pre-normalize search query (lowercase, trim) once outside the loop to improve performance.
