...
/**
 * ⚡ Bolt Optimization: UserRowComponent
 *
 * Extracted and memoized to prevent redundant re-renders of the user list
 * during search input.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtered results and normalize search term outside the loop.
