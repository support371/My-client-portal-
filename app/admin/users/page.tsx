 ...
 * This prevents re-rendering unchanged row components when typing in the search input
 * or when other state updates occur.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize user list filtering using useMemo.
  // Pre-normalize the search query outside of the loop to prevent O(N) repetitive operations.
