 ...
 * This ensures unchanged rows skip reconciliation when the search query updates,
 * significantly improving responsiveness for large datasets.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic to prevent redundant O(N) calculations.
  // Pre-calculating the search term outside the filter loop ensures efficient matching.
