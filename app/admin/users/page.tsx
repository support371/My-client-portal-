...
// Ensures stable references for memoized components like PortalHeader.
 ...
 * Prevents re-rendering all user rows when typing in the search input.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize list filtering logic and pre-normalize search query outside filter loop.
