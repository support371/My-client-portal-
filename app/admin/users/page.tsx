...
// This ensures they are not re-created as new object references on every page render.
 ...
 * Prevents unnecessary re-renders of list items when typing in the search box.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize search filter.
  // Pre-normalize query to avoid calling .toLowerCase() on every comparison loop iteration.
