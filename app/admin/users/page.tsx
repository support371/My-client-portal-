...
// ⚡ Bolt Optimization: Hoist static icons to ensure stable references.
...
/**
 * ⚡ Bolt Optimization: Memoize the UserRow component.
 * Ensures that the table rows skip reconciliation unless the user data itself changes.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Optimize filtered list with useMemo and pre-normalized search term.
