...
// ⚡ Bolt Optimization: Hoist static icons to ensure stable element references.
 ...
 * Ensures table rows only re-render when their specific data changes.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtered users with pre-normalized search query.
