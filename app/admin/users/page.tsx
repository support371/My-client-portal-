 ...
 * This ensures that when the search query changes, only rows that are being
 * added or removed from the DOM are processed, and existing rows skip reconciliation.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the filtered list to skip O(N) calculations on unrelated re-renders.
