...
// ⚡ Bolt Optimization: Move static icon elements outside component scope to maintain stable references.
 ...
 * Prevents unnecessary re-renders of all rows when typing into the search input.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize search filter and pre-calculate query term once outside the filter loop.
