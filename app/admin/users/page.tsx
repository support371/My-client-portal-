...
/**
 * ⚡ Bolt Optimization: Extract and memoize user table row.
 * Prevents redundant reconciliations of all rows when sibling or parent state changes.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Wrap filtering logic in useMemo.
  // Prevents O(N) calculations on every render unless users or search changes.
