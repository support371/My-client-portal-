...
// ⚡ Bolt Optimization: Hoist static Lucide icons outside the component to prevent recreating objects on each render.
 ...
 * This prevents unnecessary re-rendering of row items when typing in the search input.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic with pre-normalized search term.
