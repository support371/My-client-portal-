 ...
 * Prevents re-rendering the entire list when only one row might change or when
 * parent state (like search) updates but doesn't affect this specific row's data.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic to avoid O(N) work on every render.
