...
// This prevents recreation of these SVG elements on every single render.
 ...
 * Prevents re-rendering all rows when other parts of the page state (like typing in search) update.
 * Props are kept primitive/simple to optimize the reconciliation process.
 */
...
export default function AdminUsersPage() {
  ...
  // Pre-normalizing the query string outside the filter loop improves performance,
  // especially as the dataset grows (O(N) search query normalization vs O(1)).
