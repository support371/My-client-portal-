 ...
 * Prevents re-rendering the entire table when the search state changes
 * but the filtered user set remains largely the same.
 */
...
export default function AdminUsersPage() {
  ...
  // Normalizing outside the loop improves performance for larger datasets.
