...
// This ensures stable references and prevents unnecessary re-renders of memoized components.
 ...
 * Prevents unnecessary re-renders of the entire table when unrelated state changes.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic and normalize search query once.
  // This prevents redundant O(n) calculations on every render unless users or search changes.
