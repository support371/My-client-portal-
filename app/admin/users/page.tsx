...
// ⚡ Bolt Optimization: Hoist static icons out of component scope
// This prevents recreating these React elements on every render.
...
// ⚡ Bolt Optimization: Define roleVariant outside the component scope to avoid recreating on every render.
...
/**
 * ⚡ Bolt Optimization: Extract and memoize UserRowComponent.
 * This avoids unnecessary re-rendering of all user row items on every keystroke
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtered user list and pre-normalize search query outside the filter loop
