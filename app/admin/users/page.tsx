...
const USER_ICON = <ShieldCheck className="h-4 w-4 text-primary" />
 ...
 * Prevents redundant re-renders of the entire table when searching or updating state.
 */
...
export default function AdminUsersPage() {
  ...
  // This avoids redundant O(N) calculations on every render unless users or search changes.
