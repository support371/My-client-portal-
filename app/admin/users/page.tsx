 ...
 * Prevents re-rendering all rows when the search state changes in the parent.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic to avoid redundant O(N) calculations.
