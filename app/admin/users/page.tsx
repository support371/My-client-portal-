...
// ⚡ Bolt Optimization: Define roleVariant outside component scope as a module-level constant.
...
// ⚡ Bolt Optimization: Hoist static Lucide icons outside of the component to prevent recreating them on every render.
...
/**
 * ⚡ Bolt Optimization: Extract individual user rows to a memoized UserRowComponent.
 * Keeps the 'key' prop on the component instance in the parent's map loop for proper React reconciliation.
 * Prevents redundant row re-renders when the search field input changes.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Use useMemo for search filtering logic with pre-normalized search query.
