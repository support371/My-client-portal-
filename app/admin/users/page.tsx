...
// ⚡ Bolt Optimization: Hoist static icons outside the render function for stable references.
 ...
 * Prevents re-rendering the entire table when the parent state (like search) updates.
 */
