...
// This ensures stable react element references and prevents child component re-renders.
 ...
 * This prevents all user rows from re-rendering on every single keystroke in the search input.
 * Reconciliation is completely skipped for unaffected rows, resulting in high responsiveness.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize user filtering logic.
  // We compute the normalized query once outside the loop instead of on every iteration.
  // Computations are cached and only re-run when the 'users' list or 'search' query changes.
