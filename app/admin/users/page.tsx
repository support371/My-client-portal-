 ...
 * Prevents re-rendering all rows when the search query changes,
 * as only the filtered list will change.
 */
...
export default function AdminUsersPage() {
  ...
  // Normalize search query once outside the filter loop for better performance.
