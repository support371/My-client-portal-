...
// This prevents recreation of JSX objects on every render, ensuring stable prop references.
 ...
 * Prevents re-rendering all rows on every search keystroke if their data hasn't changed.
 */
