...
// ⚡ Bolt Optimization: Move static Lucide icons out of component render cycle for stable references.
 ...
 * Prevents unnecessary re-renders of the table list during parent state or search query updates.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the user list filtering logic with a pre-normalized query string.
