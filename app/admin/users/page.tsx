...
// ⚡ Bolt Optimization: Hoist static icons out of the render cycle.
// This prevents recreating React elements on every render, preserving stable object references.
...
/**
 * ⚡ Bolt Optimization: Memoize individual user row components.
 * This prevents all user rows from re-rendering when typing in the search bar
 * or during other parent state updates, significantly improving input responsiveness.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize user list filtering logic.
  // Pre-normalize the search query outside of the loop to run O(1) lowercasing/trimming
  // rather than O(N) inside the filter iteration, optimizing list updates.
                  ...
                  {filtered.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="py-8 text-center text-sm text-muted">
                        {/* ⚡ Bolt Optimization: Keeps exact required differentiating logic */}
