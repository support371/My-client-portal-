...
// This ensures stable references and prevents unnecessary re-renders of child components.
 ...
 * Prevents re-rendering all rows when unrelated page state (like the search query) updates.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic.
  // Avoids O(N) recalculations on every render if users or search hasn't changed.
