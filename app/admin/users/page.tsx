...
// ⚡ Bolt Optimization: Move static Lucide icons outside the render function to avoid recreating React element object references on every render.
 ...
 * Prevents unnecessary re-renders of unmodified rows when typing in search.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Pre-normalize search query outside the .filter() loop and wrap in useMemo.
