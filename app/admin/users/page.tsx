...
// ⚡ Bolt Optimization: Hoist static Lucide icons outside the render cycle to ensure stable references.
 ...
 * Prevents redundant re-renders of all rows when typing in search input.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize filtering logic and pre-normalize search query once outside the loop.
