...
// ⚡ Bolt Optimization: Hoist static Lucide icons outside the render function scope
// to ensure stable references and avoid unnecessary child re-renders.
...
/**
 * ⚡ Bolt Optimization: Extract the user row markup into a memoized component.
 * This prevents all other rows from re-rendering when a single user row or page state updates.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Use useMemo to cache the filtered user list,
  // pre-normalizing the search query once outside the filter loop to eliminate
  // redundant `.toLowerCase()` and `.trim()` calls per-row per-render.
