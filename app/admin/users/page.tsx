...
/**
 * ⚡ Bolt Optimization: Extract and memoize individual user table rows.
 * Allows React to skip reconciliation for rows that haven't changed during search updates.
 */
...
export default function AdminUsersPage() {
  ...
  // ⚡ Bolt Optimization: Memoize the filtered list to prevent redundant O(N) calculations.
