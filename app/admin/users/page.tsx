...
// This prevents memoized components like PortalHeader from re-rendering
// due to new object references on every parent render.
 ...
 * Prevents re-rendering the entire user table when the search state changes.
 */
...
export default function AdminUsersPage() {
  ...
  // Avoids O(N) calculations on every render cycle.
