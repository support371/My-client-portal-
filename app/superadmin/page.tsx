...
/**
 * ⚡ Bolt Optimization: Memoize Tenant rows.
 * Prevents re-renders of the entire table when unrelated state changes.
 */
...
/**
 * ⚡ Bolt Optimization: Memoize System Log items.
 * Uses a composite key for stable reconciliation and skips re-renders if log data is unchanged.
 */
