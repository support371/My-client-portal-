 ...
 * Prevents unnecessary re-renders of the entire table when only specific data changes.
 */
 ...
 * Uses a stable composite key pattern to optimize React's reconciliation process.
 */
