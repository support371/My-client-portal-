 ...
 * Prevents re-rendering entire table when only specific data changes.
 */
const TenantRow = memo(function TenantRow({ t }: { t: (typeof tenants)[0] }) {
  return (
 ...
 * Enhances performance during log updates by preventing redundant renders of old entries.
 */
const SystemLogItem = memo(function SystemLogItem({ l }: { l: (typeof logs)[0] }) {
  return (
