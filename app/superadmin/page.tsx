 ...
 * Prevents redundant renders of the tenant list when unrelated state changes.
 */
const TenantRow = memo(function TenantRow({ tenant }: { tenant: (typeof tenants)[0] }) {
  return (
 ...
 * Prevents re-rendering existing logs when new ones are added or parent state updates.
 */
const SystemLogItem = memo(function SystemLogItem({ log }: { log: (typeof logs)[0] }) {
  return (
