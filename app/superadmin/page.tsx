...
/**
 * ⚡ Bolt Optimization: Extract TenantRow to its own component.
 * Following the pattern of extracting list items for better maintainability.
 */
 ...
 * Prevents unnecessary re-renders when the parent component re-renders.
 */
